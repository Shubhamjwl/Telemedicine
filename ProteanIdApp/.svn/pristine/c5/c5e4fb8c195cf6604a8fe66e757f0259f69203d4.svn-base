...
public class ExceptionControllerAdvisor {
	...
	public ResponseEntity<ErrorResponse<ServiceError>> customExceptionHandler(
			final HttpServletRequest httpServletRequest, final UserException exception) throws IOException {
	...
	public ResponseEntity<ErrorResponse<ServiceError>> globalExceptionHandler(Exception exception,
		...
		ServiceError serviceErrors = new ServiceError(UserErrorConstant.INTERNAL_SERVER_ERROR.getErrorCode(),
