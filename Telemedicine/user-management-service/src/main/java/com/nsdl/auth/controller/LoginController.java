...
import com.nsdl.auth.dto.AboutUsPdfRequest;
...
public class LoginController {
	...
	@PostMapping(value="/downloadAboutUsPdf",produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<MainResponseDTO<AboutUsPdfResponse>> downloadAboutUsPdf(
			@RequestBody @Valid MainRequestDTO<AboutUsPdfRequest> pdfRequest) {
		logger.info("AboutUs Pdf Request Received");
		 return ResponseEntity.status(HttpStatus.OK).body(service.downloadAboutUsPdf(pdfRequest.getRequest().getPdfName()));
	}
	
	@PostMapping("/changePassword")
	public ResponseEntity<MainResponseDTO<CommonResponseDTO>> userPasswordChange(
			@RequestBody @Valid MainRequestDTO<ChangePasswordRequest> changePasswordRequest) {
		logger.info("User Change Password Request Received");
		MainResponseDTO<CommonResponseDTO> response = null;
		response = service.userChangePasswordService(changePasswordRequest);
		return ResponseEntity.status(HttpStatus.OK).body(response);
	}
