...
export class PatientData {
    ...
    constructor(jsonObj){
        ...
        this.smcno = jsonObj.smcno ? jsonObj.smcno:'';
        this.micno = jsonObj.micno ? jsonObj.micno:'';
        this.gender = jsonObj.ptGender ? jsonObj.ptGender: '';
        this.dob = jsonObj.dob ? jsonObj.dob: '';
        this.abhaId = jsonObj.abhaId ? jsonObj.abhaId: '';
        this.abhaNumber = jsonObj.abhaNumber ? jsonObj.abhaNumber: '';
        this.state = jsonObj.ptState ? jsonObj.ptState: '';
