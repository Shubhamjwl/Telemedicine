...
export class DoctorDetails {
        ...
        constructor(jsonObj){
            ...
            this.dmdConvenienceCharge = jsonObj.dmdConvenienceCharge ? jsonObj.dmdConvenienceCharge : '',
            ...
            this.dmdTcFlag =  jsonObj.dmdTcFlag ? jsonObj.dmdTcFlag : '',
...
export class DocProfileDetails {
    ...
    constructor(jsonObj){
        if(jsonObj){
            ...
            this.ConvenienceCharge= jsonObj.dmdConvenienceCharge ? jsonObj.dmdConvenienceCharge : '';
