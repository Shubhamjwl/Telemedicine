...
export class AuthService {
  ...
  signIn(data, uniqueString, captcha): Observable<any> {
    ...
    return this.httpClient
      .post<IAPIResponseWrapper<ISignInSignOutResponse>>(AppConstants.signInURL, payload, { headers })
      .pipe(map((res) => res));
  }
  ...
  getUserRole(): keyof typeof UserRole {
    return sessionStorage.getItem(this.ROLE) as any;
  }
  getDrId(): string {
  ...
  registerDoctor(payload: any, files?: any): Observable<any> {
    const file = {
      request: payload,
    };
    return this.httpClient.post(
      AppConstants.doctorRegistrationModuleURL + AppConstants.appVersion + AppConstants.saveDoctorDetailsURL,
      file,
    );
  }

  updateTermsAndCondForDoc() {
    return this.httpClient
      .get<IAPIResponseWrapper<any>>(
        AppConstants.doctorRegistrationModuleURL + AppConstants.appVersion + AppConstants.updateTermsAndCondForDoc,
      )
      .pipe(map((res) => res));
  }
  ...
  signOut(): Observable<any> {
    ...
    return this.httpClient.post<IAPIResponseWrapper<ISignInSignOutResponse>>(AppConstants.signOutURL, payload);
  }
  ...
  generateCaptcha(uniqueString: string): Observable<any> {
    ...
    return this.httpClient.post(
      AppConstants.captchaModuleURL + AppConstants.generateCaptchaURL,
      {},
  ...
  verifyCaptcha(uniqueString: string, captcha: string): Observable<any> {
    ...
    return this.httpClient.post<IAPIResponseWrapper<any>>(
      AppConstants.captchaModuleURL + AppConstants.verifyCaptchaURL,
      {},
      { headers },
    );
  }
  ...
  updatePassword(request, sessionId, captcha): Observable<any> {
    ...
    return this.httpClient
      .post<IAPIResponseWrapper<any>>(AppConstants.resetPasswordURL, payload, { headers })
      .pipe(map((res) => res));
  }
  ...
  downloadAboutUsPdf(payload): Observable<any> {
    return this.httpClient.post(AppConstants.downloadAboutUsPdf, payload).pipe(map((res) => res));
  }

  changePassword(request: ChangePasswordRequest): Observable<IAPIResponseWrapper<any>> {
    const payload = {
      id: 'user',
      version: '1.0',
      requesttime: '2020-01-02T10:01:21.331Z',
    ...
    return this.httpClient.post<IAPIResponseWrapper<any>>(AppConstants.changePasswordURL, payload);
  }
}
