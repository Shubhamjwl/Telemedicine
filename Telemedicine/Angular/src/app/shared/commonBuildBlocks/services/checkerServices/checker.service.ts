...
import { IFeaturesCategory } from '../../interfaces/ifeatures-category';
 ...
 */
  ...
  getAllFeaturesCategoryList() {
    let url = AppConstants.masterManagementModuleURL + AppConstants.getAllFeaturesCategoryList;
    return this.httpClient.get<IAPIResponseWrapper<IFeaturesCategory[]>>(url);
  }
}
