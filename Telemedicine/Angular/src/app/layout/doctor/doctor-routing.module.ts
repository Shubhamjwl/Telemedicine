...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('../registrations/register-patient/register-patient.module').then((m) => m.RegisterPatientModule),
  },
  {
    path: 'coming-soon',
  ...
  },
  {
    ...
    loadChildren: () => import('./tm-consultation/tm-consultation.module').then((m) => m.TmConsultationModule),
    canActivate: [AuthGuard],
  },
];
