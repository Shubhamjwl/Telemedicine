...
@Component({
  selector: 'app-tm-book-appointment',
  templateUrl: './tm-book-appointment.component.html',
  styleUrls: ['./tm-book-appointment.component.scss'],
})
export class TmBookAppointmentComponent implements OnInit {
