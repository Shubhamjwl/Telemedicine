		...
		return http.cors().and().exceptionHandling().authenticationEntryPoint((swe, e) -> Mono.fromRunnable(() -> {
			...
			swe.getResponse().setStatusCode(HttpStatus.FORBIDDEN);
				...
				.pathMatchers("/login/signin", "/login/validateToken", "/login/getUserDetailsAndSendOTP",
						...
						"/DoctorRegistration/v1/saveDoctorDetailsTele", "/DoctorRegistration/v1/getDoctorProfilePath",
						"/patientRegistration/registration", "/patientRegistration/patientRegistartionByExternalLink",
						...
						"/tele/saveOrderDetails", "/masterManagement/v1/getAssociationNameList",
						"/videoconference/createMeeting", "/videoconference/joinMeeting",
						"/patientRegistration/getPatientRefByPatientId", "/patientRegistration/getCareContextDetails",
						"/patientRegistration/getReportsByCareContextIds", "/patientRegistration/getNdhmFlag","/login/downloadAboutUsPdf",
						"/tele/getTransactionId","/tele/getCategoryFlagByEmailId","/masterManagement/v1/getAllFeaturesCategoryList","/masterManagement/v1/getAllDocumentList",
						"/patientVerification/searchPatientByHealthIdWot")
