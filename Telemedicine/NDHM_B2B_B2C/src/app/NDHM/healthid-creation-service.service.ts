...
export class HealthidCreationServiceService {
  ...
  helathidCreationForMobile_url = 'helathIDcreationForMobileDemo';
  ...
  helathIDcreationForPreVerified_url = 'helathIDcreationForPreVerifiedDemo';
  ...
  searchExistsByHealthId(
    ...
    this.mainRequestSearchByHealthIdDTO = new MainRequestDTO<
      SearchByHealthIdDTO
    >();
