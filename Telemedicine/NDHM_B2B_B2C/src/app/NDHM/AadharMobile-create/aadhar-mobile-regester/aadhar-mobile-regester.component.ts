    ...
    this._servises
      ...
      .subscribe(
        (result) => {
          ...
          //console.log('healthIdNumber::', result.response.healthIdNumber);
          this.healthIdNumber = result.response.healthIdNumber;
          //console.log('healthIdNumber::', this.healthIdNumber);
          localStorage.setItem('ABHA_ID', this.healthIdNumber);
          localStorage.setItem('ABHA_Address', this.healthId);
          localStorage.setItem('mobileNoSel', this.mobileNoSel);
          console.log('MOBILE_REGISTER', this.healthIdNumber, this.healthId);
          this.healthId = this.mainCreateHealthIdPreverifiedRespDTO.response.healthId.substring(
            0,
            this.mainCreateHealthIdPreverifiedRespDTO.response.healthId.length - 4
          );;
