...
public enum ErrorConstants {
	...
	UNABLE_TO_GENERATE_TOKEN("VCA-006","Error generating token for Videocall, please try again."),
	...
	MEETING_EXIST("VC-011","Meeting alreay exist with given meeting id"),
	MEETING_NOT_STARTED("VC-012","Please wait as the doctor is yet to be join");
