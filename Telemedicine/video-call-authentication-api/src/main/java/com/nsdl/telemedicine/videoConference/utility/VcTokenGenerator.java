...
public class VcTokenGenerator {
	...
	public BasicTokenDto basicGenerate(String userId, String role, String appId, String userName) throws GeneralSecurityException, IOException {
		...
		if(envFlag.equalsIgnoreCase(AuthConstant.DEV_ENV_FLAG_VIDEOCALL))
		{
