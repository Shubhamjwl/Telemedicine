...
public class PatientRegDtlsEntity implements Serializable {
	...
	@Column(name = "prd_pt_first_name", nullable = false)
	private String prdPtFirstName;
	
	@Column(name = "prd_pt_middle_name", nullable = true)
	private String prdPtMiddleName;
	
	@Column(name = "prd_pt_last_name", nullable = false)
	private String prdPtLastName;
