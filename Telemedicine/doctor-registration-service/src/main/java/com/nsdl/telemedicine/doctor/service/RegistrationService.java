...
public interface RegistrationService {
	...
	CategoryDtlsResponse fetchCategoryDtlsByDrId(String drUserName);

	MainResponseDTO<Boolean> checkDoctorTagByPatientId(MainRequestDTO<PatientDetailsRequestDTO> requestDto);
}
