...
//	@Valid
	...
	@NotNull(message = "drFirstName must not be null")
	@Valid
	private String drFirstName;
	
	private String drMiddleName;
	
	@NotNull(message = "drLastName must not be null")
	@Valid
	...
	//@NotNull(message = "drState must not be null")
	@Valid
	private String drPreassessmentLink;
	
	@Valid
	private boolean drTermsAndConditionFlag;
	...
	public String getDrPreassessmentLink() {
		return drPreassessmentLink;
	}
	public void setDrPreassessmentLink(String drPreassessmentLink) {
		this.drPreassessmentLink = drPreassessmentLink;
	}
	...
	public boolean getDrTermsAndConditionFlag() {
		return drTermsAndConditionFlag;
	}
	public void setDrTermsAndConditionFlag(boolean drTermsAndConditionFlag) {
		this.drTermsAndConditionFlag = drTermsAndConditionFlag;
	}
