...
public enum DoctorRegConstant {
	...
	DOCTOR_FIRSTNAME_VALIDATE("DOCTOR_First_NAME", "First Name must be an alphabetic value"),
	DOCTOR_LASTTNAME_VALIDATE("DOCTOR_Last_NAME", "Last Name must be an alphabetic value"),
