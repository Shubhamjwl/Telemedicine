...
public class RegistrationServiceImplTest {
	...
	public void setup() {
		...
		doctorRegDtlsDTO.setDrFirstName("saili");
	...
	public void doctorProfileTest() throws IOException {
		...
		doctorMstrDtlsDTO.setDmdDrFirstName("test");
	...
	public void updateDoctorProfileTest() throws IOException {
		...
		DoctorMstrDtlsDTO doctorMstrDtlsDTO = new  DoctorMstrDtlsDTO();
		doctorMstrDtlsDTO.setDmdUserId("722");
		doctorMstrDtlsDTO.setDmdDrFirstName("test1");
		doctorMstrDtlsDTO.setDmdDrMiddleName("test2");
		doctorMstrDtlsDTO.setDmdDrLastName("test3");
