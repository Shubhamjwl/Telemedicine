...
import { EntryLevelComponent } from './NDHM/entry-level/entry-level.component';
@NgModule({
  declarations: [
    AppComponent,
    ...
    VerfymobileprofileComponent,
    VerfymobileOTPComponent,
    VerfyAadhareOTPComponent,
    VerfyAadhareProfileComponent,
    VerfyAadhareKYCComponent,
    VerfyAadharAutherComponent,
    VerfyDemoghraphyProfilerComponent,
    VerfyDemoghraphyMapComponent,
    //HealthidDeleteComponent,
  ],
  imports: [
    NgxSpinnerModule,
    BrowserModule,
  ...
  providers: [
    ...
    DatePipe,
    {
      ...
      useClass: TelemedicineInterceptor,
      multi: true,
    },
  ],
