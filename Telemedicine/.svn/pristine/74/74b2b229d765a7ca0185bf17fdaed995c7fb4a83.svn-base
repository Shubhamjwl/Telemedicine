...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./patient-appointment-url/patient-appointment-url.module').then(
        (m) => m.PatientAppointmentUrlModule
      ),
  },
  { path: '**', redirectTo:'', pathMatch: 'full' },
  { path: 'HealthidIndex', component: HealthidIndexComponent },
  ...
  {
    path: 'healthidSearch',
    component: HealthidSearchComponent,
  },
