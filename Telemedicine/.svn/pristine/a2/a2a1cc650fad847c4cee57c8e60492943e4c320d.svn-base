...
import { PrescriptionDataSharingService } from '../../tm-consultation/prescription-data-sharing.service';
...
export class PrescriptionDetailsComponent implements OnInit {
  ...
  */
  ...
  onDoseToggleValChange(medicine, value) {
    medicine.units = value;
    this.changeEvent();
  }

  onDurationToggleValChange(medicine, value) {
