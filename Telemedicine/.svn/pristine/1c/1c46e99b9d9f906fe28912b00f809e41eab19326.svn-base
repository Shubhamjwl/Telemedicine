...
@Component({
  selector: 'app-self-verify-mobile',
  templateUrl: './self-verify-mobile.component.html',
  styleUrls: ['./self-verify-mobile.component.css'],
})
export class SelfVerifyMobileComponent implements OnInit {
  ERR = ERR_MSGS;
  PATTERN = REGEX;
  token: any;
  aadhaar: any;
  ...
  proceedWithoutAadhaar() {
    this.router.navigate(['/selfpatientreg'], {
      queryParams: {
