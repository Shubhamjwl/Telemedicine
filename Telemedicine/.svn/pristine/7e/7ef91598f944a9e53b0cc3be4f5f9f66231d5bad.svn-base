export enum ErrorSuccessMessage {
  ...
  GIVENXLSXFILE = 'Please download file from above link and attach with updated details and file name should be sample.xlsx',
  ...
  VALIDCONSULTATIONBB = 'Please wait as the doctor is yet to be join',
  SELFASSESSMENTLINK = 'Will be available shortly',
}