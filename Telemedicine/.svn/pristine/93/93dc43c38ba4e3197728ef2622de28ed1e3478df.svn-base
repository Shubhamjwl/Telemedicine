  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe((params) => {
      ...
      if (params && params.dob) {
        ...
        this.dob = params.dob;
        // console.log('123this.dob::' + this.dob);
      }
