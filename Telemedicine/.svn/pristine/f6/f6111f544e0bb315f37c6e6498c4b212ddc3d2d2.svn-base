...
@Component({
  selector: 'app-self-patient-registered',
  templateUrl: './self-patient-registered.component.html',
  styleUrls: ['./self-patient-registered.component.css'],
})
export class SelfPatientRegisteredComponent implements OnInit {
  timeLeft: number = 60;
  interval;
  startTimer() {
