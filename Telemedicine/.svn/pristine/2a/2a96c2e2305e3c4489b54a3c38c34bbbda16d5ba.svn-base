...
static roleWiseMenues = {
  ...
  "systemuser": [
    ...
    {
      "mainMenu": "Doctor Bulk Registration",
      "id": "bulkDoctor",
      "icon": "fa fa-user-md fa-fw mr-3", 
      "route" : "./checker/bulk-upload-doc"
    },
    {
      "mainMenu": "Doctor List ",
      "id": "checkListDoctor",
      "icon": "fa fa-list-alt fa-fw mr-3", 
