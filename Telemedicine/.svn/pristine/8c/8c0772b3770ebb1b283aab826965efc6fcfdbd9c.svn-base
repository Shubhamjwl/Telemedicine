...
public interface LoginUserRepo extends JpaRepository<LoginUserEntity, Integer> {
	...
	LoginUserEntity findByUserIdOrMobile(String userId, Long mobile);
...
/*	boolean existsByMobileAndUserIdNot(Long MobNo,String userId);
	...
	int userLoggedIn(@Param("userId") String userId, @Param("date") LocalDateTime date);
	...
	int userLoggedInOnPasswordExpired(@Param("userId") String userId, @Param("date") LocalDateTime date);
...
//	public int updateValidationAttemptCount(@Param("userId") String userId, @Param("date") LocalDateTime date);
	...
	int updateValidationAttemptCount(@Param("userId") String userId, @Param("date") LocalDateTime date);
	...
	@Modifying
	@Query(value = "UPDATE usrmgmt.usr_dtls SET ud_fail_attempt_count = 0,ud_logged_in_flg = false , ud_modified_by =:modifiedBy, ud_modified_tmstmp =:date WHERE ud_mobile_no =:userId", nativeQuery = true)
	int userLoggedOutWithMobileNo(@Param("userId") long userId, @Param("date") LocalDateTime date,
			@Param("modifiedBy") String modifiedBy);

	LoginUserEntity findByUserIdOrMobileOrEmail(String userId, Long mobile, String email);
//	@Modifying                                                                             
...
//	int updateUserRole(@Param ("roleId") String roleId, @Param("userId") String userId, @Param("date") LocalDateTime date);
	 ...
	 @Query(value =
			  "select ud_modified_tmstmp from usrmgmt.usr_dtls where ud_user_id =:userId", nativeQuery=true)
	public LocalDateTime getLogOutTimeByUserId(@Param("userId") String userId);
}
