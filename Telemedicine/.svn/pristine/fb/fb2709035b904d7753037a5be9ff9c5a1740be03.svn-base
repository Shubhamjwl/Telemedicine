...
@Component({
  selector: 'app-tm-create-slot',
  templateUrl: './tm-create-slot.component.html',
  styleUrls: ['./tm-create-slot.component.scss'],
})
export class TmCreateSlotComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<TmCreateSlotComponent>,
