...
public class AuthConstant {
	...
	public final static String INVALID_SMC_NO_FORMAT = "Enter valid SMC Number";

	public final static String INVALID_MCI_NO_FORMAT = "Enter valid MCI Number";
	...
	public final static String INVALID_USERID_FORMAT = "Enter valid user Id";
	...
	public final static String EMAIL_ALREADY_EXISTS = "User already Exists for given Email Id";
	...
	public final static String INVALID_VERIFICATION_REQUEST = "Ïnvalid Doctor Verification Request";

	public final static String DR_REJECT_EMPTY_REASON_ = "Please enter a valid reason.";

	public final static String DR_NOTIFY_SMS_SEND_TYPE = "SMS";

	public final static String DR_NOTIFY_EMAIL_SEND_TYPE = "email";
	...
	public final static String FUNTION_NOTFOUND_FOR_ROLE = "No Functions available for given Role ";
