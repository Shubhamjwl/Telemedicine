...
public interface HealthIdCreationByAdharService {
	...
	MainResponseDTO<GenerateOtpResp> generateOTPForAadhar(Map<String, String> headers,
	...
	MainResponseDTO<ConfirmOtpRespAadhaar> confirmOTP(Map<String, String> headers,
	...
	MainResponseDTO<CreateHealthIdPreverifiedRespDTO> helathIDcreationForPreVerifiedDemo(Map<String, String> headers,
			@Valid CreateHealthIdPreverifiedRequestDTO createHealthIdPreverifiedRequestDTO);
}
