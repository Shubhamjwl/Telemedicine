...
public class OPConsultNote {
	...
	public String getFhirString(PatientRegDetailsDTO patientRegDTO, DoctorDetailsDto doctorDetailsDto,
		...
		insertData(patientRegDTO, doctorDetailsDto, reportDtls, lastUpdatedElement);
				
		// Populate the resource
		Bundle opConsultNoteBundle = populateOPConsultNoteBundle(lastUpdatedElement, patientGender, patientUniqueId,
				patientName, doctorUniqueId, doctorName);
	...
	static Composition populateOPConsultNoteCompositionResource(String lastUpdatedElement, String patientUniqueId,
	...
	Bundle populateOPConsultNoteBundle(String lastUpdatedElement, String patientGender, String patientUniqueId,
											  String patientName, String doctorUniqueId, String doctorName) {
		...
		bundleEntry1.setResource(populateOPConsultNoteCompositionResource(lastUpdatedElement, patientUniqueId, patientName,
				doctorUniqueId, doctorName));
	...
	public void insertData(PatientRegDetailsDTO patientRegDTO, DoctorDetailsDto doctorDetailsDto,
						   ReportResponseDtls reportDtls,String lastUpdatedElement) {
		...
		documentReferenceDTO.setId("DocumentReference-01");
		...
		documentReferenceDTO.setDocumentText(reportDtls.getReport_type());
		documentReferenceDTO.setDocContentType("application/pdf");
		documentReferenceDTO.setDocLanguage("en-IN");
		documentReferenceDTO.setDocTitle(reportDtls.getReport_type());
		documentReferenceDTO.setDocCreationDate(lastUpdatedElement);
		documentReferenceDTO.setDocData(reportDtls.getReport_doc());

		opConsultResource.setDocumentReferenceDTO(documentReferenceDTO);

		EncounterDTO encounterDTO = new EncounterDTO();
		encounterDTO.setId("Encounter-01");
