package com.nsdl.telemedicine.master.exception;
...
//import com.nsdl.tin.auth.util.EmptyCheckUtility;
	...
	public MainResponseDTO<Object> handleValidationExceptions(
	  MethodArgumentNotValidException ex) {
	    ...
	    ex.getBindingResult().getAllErrors().forEach((error) -> {
	        ...
	        MasterUtility.getExceptionList(errorList, fieldName, errorMessage);
	    });
