...
public class MasterManagementController {
	...
	@GetMapping("/getAssociationNameList")
	...
	@GetMapping("/getAllFeaturesCategoryList")
	public MainResponseDTO<List<FeatureCategoryResponse>> getAllFeaturesCategoryList() {
		MainResponseDTO<List<FeatureCategoryResponse>> responseDTO = new MainResponseDTO<List<FeatureCategoryResponse>>();
		try {
			logger.info("Receive request");
			List<FeatureCategoryResponse> allCategoryNameList = service.getAllFeaturesCategoryList();
			responseDTO.setResponse(allCategoryNameList);
			responseDTO.setId("master");
			responseDTO.setVersion("1.0");
			responseDTO.setStatus(true);
			responseDTO.setResponsetime(DateUtils.getUTCCurrentDateTimeString());
	...
	public MainResponseDTO<List<DocumentResponse>> getAllDocumentList() {
		MainResponseDTO<List<DocumentResponse>> responseDTO = new MainResponseDTO<List<DocumentResponse>>();
		try {
			logger.info("Receive request");
			List<DocumentResponse> allDocumentList = service.getAllDocumentList();
			responseDTO.setResponse(allDocumentList);
			responseDTO.setId("master");
			responseDTO.setVersion("1.0");
			responseDTO.setStatus(true);
			responseDTO.setResponsetime(DateUtils.getUTCCurrentDateTimeString());
