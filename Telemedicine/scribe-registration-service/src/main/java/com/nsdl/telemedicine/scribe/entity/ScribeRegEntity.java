...
public class ScribeRegEntity {
	...
	@Column(name = "srd_scrb_name", length = 100, nullable = false)
	...
	@Column(name = "srd_photo_path", nullable = true)
	...
	@Column(name = "srd_gender", length = 10)
	private String scrbGender;
	
	@Column(name = "srd_state", length = 50)
	private String scrbState;
	
	@Column(name = "srd_city", length = 50)
