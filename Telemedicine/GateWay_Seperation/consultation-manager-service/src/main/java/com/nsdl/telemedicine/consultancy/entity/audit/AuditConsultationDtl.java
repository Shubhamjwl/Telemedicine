...
@NoArgsConstructor
@Entity
@Table(name="consultation_dtls_audit", schema = "audit")
public class AuditConsultationDtl implements Serializable {
...
//	@GeneratedValue(strategy=GenerationType.IDENTITY)
	...
	private void prePersist() {
		ctCreatedTmstmp = LocalDateTime.now();
		ctModifiedTmstmp = LocalDateTime.now();
