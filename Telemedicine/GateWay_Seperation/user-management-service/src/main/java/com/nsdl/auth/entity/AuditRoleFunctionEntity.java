...
@Entity
@Table(name = "aud_role_function_dtls", schema = "audit")
public class AuditRoleFunctionEntity extends BaseEntity implements Serializable {

	private static final long serialVersionUID = -8541947597557592398L;
